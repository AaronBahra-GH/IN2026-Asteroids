...
Animation* AnimationManager::CreateAnimationFromFile(const string& name, const uint width, const uint height, const uint frame_width, const uint frame_height, const string& filename)
{
